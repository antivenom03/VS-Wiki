...
var html_url_prefix = "/VS-Wiki";
var CONFIGURED_HTML_URL_PREFIX = "/VS-Wiki";
...
var gzip_hash = '112555780031567014681587684722486510193'                       // used to check whether the localStorage data is stale
...
function get_html_url_prefix(){
    return '/VS-Wiki'  // this value is replaced by the actual url prefix when compiled
}
